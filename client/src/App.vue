                ...
                <q-toolbar class="row justify-between">
                    ...
                    <div class="col-8">
                        <q-tabs style="padding-top: 8px">
                            ...
                            <q-route-tab v-if="!viewHidden('/quicktag')" :disable="$1t.lock.value.locked" to="/quicktag" class="text-weight-bolder" @click="showSide" >Quick Tag</q-route-tab >
                            <q-route-tab v-if="!viewHidden('/tageditor')" :disable="$1t.lock.value.locked" to="/tageditor" class="text-weight-bolder" @click="hideSide" >Edit Tags</q-route-tab >
